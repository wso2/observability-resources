class fluentbit::params inherits common::params {
  $fluentbit_version = '3.1.10'
  $config_path = "${deployment_dir}/fluentbit/config.toml"
  ...
  $bal_logs_path = "${deployment_dir}/bal/samples/shipment/shipments.logs"
